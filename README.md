...
```text
ghcr.io/mjjuniorr/controle-remessas-web:4f02b04
...
```bash
docker tag controle-remessas-web:latest ghcr.io/mjjuniorr/controle-remessas-web:4f02b04
docker push ghcr.io/mjjuniorr/controle-remessas-web:4f02b04
